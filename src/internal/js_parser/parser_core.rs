...
pub(crate) struct ParserCore {
    ...
    pub(crate) jsx_source_offset: usize,
    pub(crate) jsx_source_line: usize,
    pub(crate) jsx_source_column: usize,
    ...
    pub(crate) esm_import_statement_keyword: Range,
    ...
    pub(crate) visit_is_generator: bool,
...
impl ParserCore {
    pub(crate) fn new(source: Source, options: Options) -> Self {
        ...
        Self {
            ...
            esm_import_statement_keyword: Range::default(),
