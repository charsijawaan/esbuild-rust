...
The test suite includes 4,918 concrete cases extracted from the pinned upstream
esbuild revision: 4,291 parser/printer cases, 626 bundler output snapshots, and
