...
The test suite includes 12,227 active concrete cases extracted from the pinned
upstream esbuild revision: 11,301 parser/printer cases, 815 bundler output
snapshots, 78 bundler diagnostic cases, and 33 Go API cases. Another 1,811 captured cases remain
