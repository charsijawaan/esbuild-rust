...
The test suite includes 4,880 concrete cases extracted from the pinned upstream
esbuild revision: 4,291 parser/printer cases, 588 bundler output snapshots, and
