...
The test suite includes 12,045 active concrete cases extracted from the pinned
upstream esbuild revision: 11,152 parser/printer cases, 815 bundler output
snapshots, and 78 bundler diagnostic cases. Another 1,960 captured cases remain
