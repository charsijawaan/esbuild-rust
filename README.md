...
The test suite includes 5,048 concrete cases extracted from the pinned upstream
esbuild revision: 4,291 parser/printer cases, 750 bundler output snapshots, and
seven bundler diagnostic cases. The checked-in fixtures make these tests
