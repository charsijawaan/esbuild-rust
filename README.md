...
The test suite includes 12,064 active concrete cases extracted from the pinned
upstream esbuild revision: 11,171 parser/printer cases, 815 bundler output
snapshots, and 78 bundler diagnostic cases. Another 1,941 captured cases remain
