...
The test suite includes 12,230 active concrete cases extracted from the pinned
upstream esbuild revision: 11,304 parser/printer cases, 815 bundler output
snapshots, 78 bundler diagnostic cases, and 33 Go API cases. Another 1,808 captured cases remain
