...
The test suite includes 4,866 concrete cases extracted from the pinned upstream
esbuild revision: 4,291 parser/printer cases, 574 bundler output snapshots, and
