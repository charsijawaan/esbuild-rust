...
The test suite includes 4,852 concrete cases extracted from the pinned upstream
esbuild revision: 4,291 parser/printer cases, 560 bundler output snapshots, and
