...
The test suite includes 12,246 active concrete cases extracted from the pinned
upstream esbuild revision: 11,304 parser/printer cases, 827 bundler output
snapshots, 82 bundler diagnostic cases, and 33 Go API cases. Another 1,792 captured cases remain
