...
The test suite includes 12,161 active concrete cases extracted from the pinned
upstream esbuild revision: 11,171 parser/printer cases, 815 bundler output
snapshots, and 78 bundler diagnostic cases. Another 1,844 captured cases remain
