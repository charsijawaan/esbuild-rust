...
The test suite includes 5,010 concrete cases extracted from the pinned upstream
esbuild revision: 4,291 parser/printer cases, 718 bundler output snapshots, and
