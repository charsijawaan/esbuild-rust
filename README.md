...
The test suite includes 4,944 concrete cases extracted from the pinned upstream
esbuild revision: 4,291 parser/printer cases, 652 bundler output snapshots, and
