...
The test suite includes 4,877 concrete cases extracted from the pinned upstream
esbuild revision: 4,291 parser/printer cases, 585 bundler output snapshots, and
