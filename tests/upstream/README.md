...
The active bundler tranche exact-compares 583 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,875 concrete upstream cases are
currently active in `cargo test`; the remaining 487 captured bundler cases are
