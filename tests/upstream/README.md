...
The active bundler tranche exact-compares 750 Unix snapshots and four
...
also covered. So 5,046 concrete upstream cases are currently active in
`cargo test`; the remaining 316 captured bundler cases are the parity backlog,
