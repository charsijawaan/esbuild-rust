...
The active bundler tranche exact-compares 578 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,870 concrete upstream cases are
currently active in `cargo test`; the remaining 492 captured bundler cases are
