...
The active bundler tranche exact-compares 560 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,852 concrete upstream cases are
currently active in `cargo test`; the remaining 511 captured bundler cases are
