...
The active bundler tranche exact-compares 748 Unix snapshots from the default,
...
assignment, and `export * as` lowering. It also
...
also covered. So 5,040 concrete upstream cases are currently active in
`cargo test`; the remaining 322 captured bundler cases are the parity backlog,
