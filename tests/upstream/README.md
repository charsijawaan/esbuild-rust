...
The active bundler tranche exact-compares 750 Unix snapshots and 41
...
also covered. So 5,083 concrete upstream cases are currently active in
`cargo test`; the remaining 279 captured bundler cases are the parity backlog,
