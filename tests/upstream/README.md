...
The active bundler tranche exact-compares 750 Unix snapshots and six
...
also covered. So 5,048 concrete upstream cases are currently active in
`cargo test`; the remaining 314 captured bundler cases are the parity backlog,
