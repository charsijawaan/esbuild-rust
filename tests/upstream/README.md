...
The active bundler tranche exact-compares 571 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,863 concrete upstream cases are
currently active in `cargo test`; the remaining 500 captured bundler cases are
