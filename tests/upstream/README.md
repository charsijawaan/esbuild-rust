...
The active bundler tranche exact-compares 579 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,871 concrete upstream cases are
currently active in `cargo test`; the remaining 491 captured bundler cases are
