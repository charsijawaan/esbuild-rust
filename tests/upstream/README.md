...
The active bundler tranche exact-compares 570 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,862 concrete upstream cases are
currently active in `cargo test`; the remaining 501 captured bundler cases are
