...
The active bundler tranche exact-compares 750 Unix snapshots from the default,
...
also covered. So 5,042 concrete upstream cases are currently active in
`cargo test`; the remaining 320 captured bundler cases are the parity backlog,
