...
The active bundler tranche exact-compares 537 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,829 concrete upstream cases are
currently active in `cargo test`; the remaining 534 captured bundler cases are
