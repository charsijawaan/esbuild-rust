...
The active bundler tranche exact-compares 582 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,874 concrete upstream cases are
currently active in `cargo test`; the remaining 488 captured bundler cases are
