...
The active bundler tranche exact-compares 581 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,873 concrete upstream cases are
currently active in `cargo test`; the remaining 489 captured bundler cases are
