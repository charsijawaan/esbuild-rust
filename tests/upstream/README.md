...
The active bundler tranche exact-compares 750 Unix snapshots and 50
...
also covered. So 5,092 concrete upstream cases are currently active in
`cargo test`; the remaining 270 captured bundler cases are the parity backlog,
