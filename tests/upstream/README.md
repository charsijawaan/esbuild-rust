...
The active bundler tranche exact-compares 580 Unix snapshots from the default,
...
diagnostic-only case is also covered. So 4,872 concrete upstream cases are
currently active in `cargo test`; the remaining 490 captured bundler cases are
